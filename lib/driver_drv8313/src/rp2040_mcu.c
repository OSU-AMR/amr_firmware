...
void *_configure6PWM(long pwm_frequency, float dead_zone, const int pinA_h, const int pinA_l, const int pinB_h,
                     const int pinB_l, const int pinC_h, const int pinC_l) {
    // non-PIO solution...
    RP2040DriverParams *params = malloc(sizeof(*params));
    // if (!pwm_frequency || !_isset(pwm_frequency))
    //     pwm_frequency = _PWM_FREQUENCY;
...
//         writeDutyCycle(swDti(dc_a, ((RP2040DriverParams *) params)->dead_zone),
//                        ((RP2040DriverParams *) params)->slice[1], ((RP2040DriverParams *) params)->chan[1]);
//     else
...
//         writeDutyCycle(swDti(dc_b, ((RP2040DriverParams *) params)->dead_zone),
//                        ((RP2040DriverParams *) params)->slice[3], ((RP2040DriverParams *) params)->chan[3]);
//     else
...
//         writeDutyCycle(swDti(dc_c, ((RP2040DriverParams *) params)->dead_zone),
//                        ((RP2040DriverParams *) params)->slice[5], ((RP2040DriverParams *) params)->chan[5]);
//     else
